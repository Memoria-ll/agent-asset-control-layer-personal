        ...
        if (kind === 'workflow') {
            ...
            const assignments = [...form.querySelectorAll('.stage-editor')].map(row => {
                ...
                if (!panel.hidden) {
                    ...
                    newRoleChanges.push({ type: 'asset.create', id: roleId, asset: { kind: 'role', name: roleName, description, body: '', responsibilities: row.querySelector('[name=newRoleResponsibilities]').value, scope: 'global', useCase: false, taskType: '', modelName: '', invocationMethod: '', metadata: {}, supportingFiles: {}, stages: [], transitions: [], entryStage: '' } });
