...
function stageRow(s: { id: string; name: string; completion_condition: string; additionalInstructions?: string }, index: number, roleId = '', modelId = '', transitions: Asset['transitions'] = [], stages: { id: string; name: string }[] = []) {
