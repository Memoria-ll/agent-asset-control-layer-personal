...
function stageBindingChanges(workflowId: string, scope: string, purpose: 'stage-role' | 'stage-model', assignments: { stageId: string; targetId: string; selectedChoices?: Record<string, string>; selectedChoiceIds?: Record<string, string> }[], bindings: Binding[]): Change[] {
...
export function stageModelBindingChanges(workflowId: string, scope: string, assignments: { stageId: string; modelId: string; selectedChoices?: Record<string, string>; selectedChoiceIds?: Record<string, string> }[], bindings: Binding[]): Change[] {
